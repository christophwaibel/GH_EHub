...
namespace EaCS3EHub
{
    public class EaCS3EHubComponent : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (run) 
            {
                // because I don't know a better way yet of parsing information between GH and an .exe:
                // write csvs that will be read by the exe

                //run ehub.exe
                string command = @"2";
                RunEhub(ehub, command);

                // read csv results file that are generated by the .exe and output them here in GH

                // delete all those csv files.
            }
