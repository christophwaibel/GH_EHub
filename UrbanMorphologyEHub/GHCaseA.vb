...
Public Class GHCaseA
    Inherits GH_Component
    ''' <summary>
    ''' Initializes a new instance of the GHCaseA class.
    ''' </summary>
    Public Sub New()
        MyBase.New("CaseA - EHub", "CaseA-EHub", _
                    "Case A - EHub MILP Solver, using 5 Solar Potentials and 3 Demands (heating, cooling, electricity)", _
                    "EnergyHubs", "Examples")
    End Sub
    ...
    Protected Overrides Sub SolveInstance(DA As IGH_DataAccess)
        ...
        Dim ehub As CaseA = New CaseA
        ehub.RunCaseA(strInput, period, co2reduc, _
                     solMaxArea, solarPotList, cool, heat, elec)
    ...
    Public Overrides ReadOnly Property ComponentGuid() As Guid
        Get
            Return New Guid("{524137a8-98f9-4d17-9470-be55cc1b9fae}")
        End Get
    End Property
End Class